...
import com.dwu.app.Chef;

import com.dwu.app.R;
import com.dwu.app.SendNotification.APIService;
import com.dwu.app.SendNotification.Client;
import com.dwu.app.SendNotification.Data;
import com.dwu.app.SendNotification.MyResponse;
import com.dwu.app.SendNotification.NotificationSender;
...
public class ChefPreparedOrderView extends AppCompatActivity {
    ...
    TextView grandtotal, name, number;
    LinearLayout l1;
    Button Prepared;
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                    ...
                                                    FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child(deliveryId).child(RandomUID).child("OtherInformation").setValue(hashMap1).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            FirebaseDatabase.getInstance().getReference("ChefFinalOrders").child(chefid).child(RandomUID).child("OtherInformation").child("button").setValue("Deliver");
                                                                ...
                                                                public void onSuccess(Void aVoid) {
                                                                    FirebaseDatabase.getInstance().getReference().child("Tokens").child(deliveryId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                        ...
                                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                            ...
                                                                            builder.setMessage("Order is ready to send...");
                                                                            ...
                                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                                ...
                                                                                public void onClick(DialogInterface dialog, int which) {
                                                                                    ...
                                                                                    FirebaseDatabase.getInstance().getReference("CustomerFinalOrders").child(userid).child(RandomUID).child("OtherInformation").child("Status").setValue("Order is prepared and ready to deliver...");
                                                                                    Prepared.setText(chefFinalOrders1.getButton());
                                                                            ...
                                                                            alert.show();}
                                                                                ...
                                                                                AlertDialog.Builder builder = new AlertDialog.Builder(ChefPreparedOrderView.this);
                                                                                builder.setMessage("Order has been delivered");
                                                                                builder.setCancelable(false);
                                                                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                                    @Override
                                                                                    public void onClick(DialogInterface dialog, int which) {

                                                                                        FirebaseDatabase.getInstance().getReference("ChefFinalOrders").child(chefid).child(RandomUID).child("OtherInformation").child("button").setValue("Delivered");
                                                                                        FirebaseDatabase.getInstance().getReference("CustomerFinalOrders").child(userid).child(RandomUID).child("OtherInformation").child("Status").setValue("Order is Delivered...");
                                                                                        Prepared.setText(chefFinalOrders1.getButton());
